...
import { FaHeartbeat, FaEnvelope, FaLock, FaEye, FaEyeSlash, FaSignInAlt } from 'react-icons/fa';
    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-primary-50 via-white to-accent-50 dark:from-dark-950 dark:via-dark-900 dark:to-dark-950 py-20 px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-dark-900 dark:text-white">تسجيل الدخول</h2>
          <p className="text-dark-500 dark:text-dark-400 mt-2">أهلاً بعودتك! أدخل بياناتك للدخول</p>
        </div>
        ...
        <div className="p-8 rounded-3xl bg-white dark:bg-dark-800/70 backdrop-blur-xl border border-gray-100 dark:border-dark-700/50 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pr-12 pl-12 py-3.5 rounded-xl border border-gray-200 dark:border-dark-600 bg-white dark:bg-dark-800 text-dark-900 dark:text-white text-right focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-dark-400 hover:text-dark-600 dark:hover:text-dark-200"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 rounded-2xl gradient-bg text-white font-bold text-lg flex items-center justify-center gap-3 hover:shadow-2xl hover:shadow-primary-500/30 transition-all disabled:opacity-60"
            >
              {loading ? (
